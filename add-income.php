...
if(isset($_POST['submit']))
  {
    ...
    $query=mysqli_query($con, "insert into tblincome(UserId,IncomeDate,IncomeItem,IncomeMoney) value('$userid','$dateexpense','$item','$costitem')");
if($query){
    ...
    echo $msg;
						...
						<div class="col-md-12">
							...
							<form role="form" method="post" action="">
								...
								<div class="form-group">
									<label>Income in Rupees(NPR):</label>
