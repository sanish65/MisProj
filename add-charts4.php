...
$tdate="2021";
 ...
 $sum4=0;
 $sum5=0;
 $ret=mysqli_query($con,"SELECT ExpenseCost as y,year(ExpenseDate) as label FROM tblexpense  where (year(ExpenseDate) BETWEEN '$fdate' and '$tdate')");
 $cnt=1;
...
//  print_r($dataPoints);
 echo"<div id='namespace' >your expenses in years</div>
